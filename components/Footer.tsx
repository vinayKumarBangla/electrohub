...
export default function Footer() {
  return (
    <footer className="bg-[#05070a] border-t border-slate-800 text-slate-400 text-xs mt-20">
      
      {/* 1. Popular Categories Directory Section */}
      ...
      {/* 2. Main Footer Links & Company Info */}
      ...
      <div className="border-t border-slate-800/60 py-6 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500">
          <div>
            Copyright © 2026 ElectroHub. All rights reserved. | Technology Partner - <span className="text-slate-400">ElectroCore</span>
          </div>
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400">
            <span className="bg-blue-600 px-2 py-1 rounded text-white">VISA</span>
            <span className="bg-blue-800 px-2 py-1 rounded text-white">MASTER</span>
            <span className="bg-cyan-600 px-2 py-1 rounded text-white">UPI</span>
          </div>
        </div>
      </div>
