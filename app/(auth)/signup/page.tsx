...
import { ShieldCheck, Loader2, User, Mail, Lock, AlertCircle } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Account created successfully! Welcome to TechCart OS.');
      router.push('/');
      router.refresh();
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-[#07090e] text-white flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-[#0d1322] border border-gray-800 rounded-3xl p-8 space-y-6 shadow-2xl">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-gray-400">Create your account to start shopping</p>
        </div>
